package com.example.simplemusicplayer.activity;
...
import com.example.simplemusicplayer.adapter.AlbumDetailsAdapter;
...
public class AlbumDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(image != null) {
            ...
            Glide.with(this).load(R.drawable.icon_music).into(albumPhoto);
        }
    }
